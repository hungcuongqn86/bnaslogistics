!function (e, t) {
    ...
    1: [function (e, t, n) {
        ...
        var W = {
            ...
            pe = $("#J_box_buycart, #J_juValid, .tb-action, .obj-order"), me = ae.createClass({
        ...
        "undefined" != typeof window && (window.React = ae), window.addEventListener("message", function (e) {
            ...
            })), console.log("truoc render"), f() && !j() && (console.log("render"), d(), $(W[oe].translate.originPrice).text("Giá"), $(W[oe].translate.promoPrice).text("Giá bán"), $(W[oe].translate.size).text("Kích thước"), $(W[oe].translate.color).text("Màu sắc"), $(W[oe].translate.amount).text("Số lượng"), $(W[oe].translate.unit).text("sản phẩm"), pe.before(ue), le.render(ae.createElement(me, {btnname: se}), document.getElementById("cart-thqc-parent")), V())
