!function (e, t) {
    ...
    1: [function (e, t, n) {
        ...
        function F() {
            ...
            var r = ['<div id="tbe-info-shop">', '<h5>NGUONHANG.NET</h5>', '<img style="width:70px;" src="' + chrome.runtime.getURL("images/144x144.png") + '" alt="' + te + '" />', "<ul>", '<li>Giá bán: <b class="tbe-color-price">' + i + "</b> đ</li>", '<li>Tỷ giá: <span class="tbe-rate tbe-color-price">' + ie.rate.format() + "</span> đ/tệ</li>", "</ul>", e, '<div class="tbe-info-warning"><p>(!!) Vui lòng chọn đầy đủ thông tin sản phẩm ở bên dưới để xem giá chuẩn.</p><p>(!!) không dùng Google Translate khi thêm sản phẩm.</p></div>', "</div>"].join("");
