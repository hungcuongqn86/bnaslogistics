    ...
    1: [function (e, t, n) {
        ...
        function L() {
            o(q, function (e) {
                if(typeof e.tbex_thqc_token === 'undefined' || e.tbex_thqc_token === null) {
                    alert('Phiên làm việc hết hạn! Bạn cần đăng nhập order.bnaslogistics.com trước khi đặt hàng!');
                    window.location.href = "https://order.bnaslogistics.com/login";
                    return;
                }
        ...
        function V() {
            o(q, function (tk) {
                ...
                var e = "", t = "";
                "1688" == oe && (e = x(), t = C()), "taobao" == oe && (e = y(), t = _()), "tmall" == oe && (e = w(), t = E()),
                    $.ajax({
                        url: ie.apiShopUrl,
                        type: "POST",
                        dataType: 'json',
        ...
        function F() {
            ...
            } else t = $("#J_EmStock, #J_SpanStock").text(), t.length > 0 && (t = H(t), t = parseInt(t)), "number" == typeof t && (e += "tmall" == oe ? '<dl><dd style="width:100%"><span class="text-danger"></span></dd></dl>' : '<dl><dd style="width:100%"><span class="text-danger"></span></dd></dl>'), i = Math.round(n.orgPrice * ie.rate).format(), n.orgPrice > 0 && n.orgPrice > n.proPrice || (0 == n.orgPrice || isNaN(n.orgPrice)) && n.proPrice > 0 ? i = Math.round(n.proPrice * ie.rate).format() : (n.lowPrice > 0 && n.highPrice > 0 && (i = Math.round(n.lowPrice * ie.rate).format() + " - " + Math.round(n.highPrice * ie.rate).format()), n.lowPromo > 0 && n.highPromo > 0 && (i = Math.round(n.lowPromo * ie.rate).format() + " - " + Math.round(n.highPromo * ie.rate).format()));
            e.length > 0 && (e = '<div class="bg-info">' + e + "</div>");
            var r = ['<div id="tbe-info-shop">', '<img style="width:70px;" src="' + chrome.extension.getURL("images/144x144.png") + '" alt="' + te + '" />', "<ul>", '<li>Giá bán: <b class="tbe-color-price">' + i + "</b> đ</li>", '<li>Tỷ giá: <span class="tbe-rate tbe-color-price">' + ie.rate.format() + "</span> đ/tệ</li>", "</ul>", e, "</div>"].join("");
        ...
        var W = {
            ...
            Z = J + "/api/public/api/shop/create", ee = J + "/api/public/api/cart/create", te = "THQC", ne = ".tbe-rate", ie = {
            ...
            pe = $("body"), me = ae.createClass({
                displayName: "BtnAddPro", cartLink: function () {
                    ...
                    return ae.createElement("div", null,
                        ae.createElement("DIV", {
                            id: "cart-thqc-warning",
                            size: "100"
                        }, ae.createElement("span", {className: "text-center success"}, this.props.message)),
                        ...
                        }, ae.createElement("img", {src: e}), ae.createElement("sup", {className: "pro-thqc-add-new"}, " ")))
                }
            });
        "undefined" != typeof window && (window.React = ae), window.addEventListener("message", function (e) {
            if (e.origin == 'https://order.bnaslogistics.com') {
                var t = {};
                switch (e.data.type) {
                    case K:
                        var n = e.data.id;
            ...
            })), console.log("truoc render"), f() && !j() && (console.log("render"), d(), $(W[oe].translate.originPrice).text("Giá"), $(W[oe].translate.promoPrice).text("Giá bán"), $(W[oe].translate.size).text("Kích thước"), $(W[oe].translate.color).text("Màu sắc"), $(W[oe].translate.amount).text("Số lượng"), $(W[oe].translate.unit).text("sản phẩm"), pe.append(ue), le.render(ae.createElement(me, {btnname: se}), document.getElementById("cart-thqc-parent")), V())
